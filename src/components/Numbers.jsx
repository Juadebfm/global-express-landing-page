...
const Numbers = () => {
  return (
    <div className="px-16 mt-6 grid grid-cols-4 border-t border-b border-white max-md:px-6 max-md:grid-cols-2 max-sm:px-4 max-sm:grid-cols-1">
      <div className="border-r border-white p-6 py-12 max-md:border-b max-sm:border-r-0">
        <img className="mx-auto" src={One} alt="" />
        <h3 className="mt-10 text-[#FFFFFF] max-sm:text-center">Safe Cargo</h3>
        <p className="text-[#FFFFFF] mt-6 max-sm:text-center">
      ...
      <div className="border-r border-white p-6 py-12 max-md:border-b max-sm:border-r-0">
        <img className="mx-auto" src={One} alt="" />
        <h3 className="mt-10 text-[#FFFFFF] max-sm:text-center">
          Fast Shipment
        </h3>
        <p className="text-[#FFFFFF] mt-6 max-sm:text-center">
      ...
      <div className="border-r border-white p-6 py-12 max-md:border-r-0 max-md:border-b max-sm:border-r-0">
        <img className="mx-auto" src={One} alt="" />
        <h3 className="mt-10 text-[#FFFFFF] max-sm:text-center">
          Affordable Prices
        </h3>
      ...
      <div className="border-l border-white p-6 py-12 max-md:border-l-0 max-sm:border-l-0 max-sm:border-b-0">
        <img className="mx-auto" src={One} alt="" />
        <h3 className="mt-10 text-[#FFFFFF] max-sm:text-center">
          Door Step Delivery
        </h3>
