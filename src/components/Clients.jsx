...
const Clients = () => {
  ...
  return (
    <div className="page-shell mt-24 mb-16 max-md:mt-20 max-md:mb-12 max-sm:mt-16 max-sm:mb-8">
      <div
        className="page-frame relative h-[450px] bg-cover bg-center bg-no-repeat max-md:h-auto max-sm:flex max-sm:items-center max-sm:justify-center max-sm:py-12"
